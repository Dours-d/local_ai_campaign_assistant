...
# Campaign Config for Youssef and his family (130822)
CAMPAIGN = {
    "title": "Help Youssef and his family survive the war",
    "description": "Please help Youssef and his family survive these difficult times in Gaza. Your support can save lives.",
    "goal": 5000,
    "image_path": r"C:\Users\gaelf\Pictures\GAZA\Youssef (Mahmoud)\WhatsApp Image 2025-05-06 à 19.57.01_3fd6120e.jpg"
}
...
def main():
    ...
    js3_goal = f"""
    (function() {{
        const g = document.querySelector('input[placeholder="Target Amount"]');
        if (g) {{
    ...
    """
    print(f"Goal: {run_js(ws, js3_goal)}")
